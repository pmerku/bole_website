...
// TODO fix privacy policy
export function Privacy() {
  return (
    <div className="privacy-wrapper">
      <h1>Privacy Policy for Bole</h1>

      <p>
        At Bole Website, accessible from https://www.example.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Bole Website and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Bole Website. This policy is not applicable to
      ...
      <p>
        Bole Website follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Bole Website uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of Bole Website.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Bole Website, which are sent
      ...
      <p>
        Note that Bole Website has no access to or control over these cookies
      ...
      <p>
        Bole Website&apos;s Privacy Policy does not apply to other advertisers
      ...
      <p>
        Bole Website does not knowingly collect any Personal Identifiable
