...
export function TOSView() {
  return (
    <div className="tos-wrapper">
      ...
      <p>
        By accessing this Website, accessible from https://www.example.com, you
      ...
      <p>
        ...
        on Bole&apos;s Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Bole&apos;s
          Website;
        </li>
        <li>
      ...
      <p>
        This will let Bole to terminate upon violations of any of these
      ...
      <p>
        All the materials on Bole’s Website are provided &quot;as is&quot;. Bole
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, Bole does not make any
      ...
      <p>
        Bole or its suppliers will not be hold accountable for any damages that
        will arise with the use or inability to use the materials on Bole’s
        Website, even if Bole or an authorize representative of this Website has
      ...
      <p>
        The materials appearing on Bole’s Website may include technical,
        typographical, or photographic errors. Bole will not promise that any of
        the materials in this Website are accurate, complete, or current. Bole
        may change the materials contained on its Website at any time without
        notice. Bole does not make any commitment to update the materials.
      </p>

      <h2>6. Links</h2>

      <p>
        Bole has not reviewed all of the sites linked to its Website and is not
        responsible for the contents of any such linked site. The presence of
        any link does not imply endorsement by Bole of the site. The use of any
      ...
      <p>
        Bole may revise these Terms of Use for its Website at any time without
      ...
      <p>
        Any claim related to Bole&apos;s Website shall be governed by the laws
